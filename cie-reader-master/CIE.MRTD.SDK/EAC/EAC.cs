    ...
    public class EAC
    {
        ...
        void PACE(ByteArray PasswordSeedData,PACEMode mode) {
            try
            {
                ...
                if (sw != 0x9000)
                    throw new ApduException(sc, sw, "Errore nel protocollo PACE:MSE Set AT");
                ...
                if (sw != 0x9000)
                    throw new ApduException(sc, sw, "Errore nel protocollo PACE:General Authenticate 1");
                ...
                if (sw != 0x9000)
                    throw new ApduException(sc, sw, "Errore nel protocollo PACE:General Authenticate 2");
                ...
                if (sw != 0x9000)
                    throw new ApduException(sc, sw, "Errore nel protocollo PACE:General Authenticate 3");
                ...
                if (sw != 0x9000)
                    throw new ApduException(sc, sw, "Errore nel protocollo PACE:General Authenticate 4");
            ...
            {
                throw new EACException("Errore nella verifica PACE", ex);
            }
